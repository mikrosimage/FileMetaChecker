...
//	COMMON_COUT_VAR( sys_info.sharedram * sys_info.mem_unit );
//	COMMON_COUT_VAR( sys_info.bufferram * sys_info.mem_unit );
	#else
	infos._totalRam             =
	    infos._freeRam          =
	        infos._totalSwap    =
	...
	#endif
	COMMON_COUT_X_DEBUG( 40, "-=" );
	COMMON_COUT_DEBUG( "Memory infos" );
	COMMON_COUT_DEBUG( infos );
