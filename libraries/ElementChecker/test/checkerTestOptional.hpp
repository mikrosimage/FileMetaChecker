...
BOOST_AUTO_TEST_CASE( element_checker_checker_optional_repeated )
{
	...
	LOG_INFO( "\n>>> element_checker_checker_optional_repeated valid <<<" );
	{
		...
		elem3->set( buff2, checker.getSize( elem3 ) );
		checker.check( elem3 );
		...
		elem5->set( buff3, checker.getSize( elem5 ) );
		checker.check( elem5 );
...
BOOST_AUTO_TEST_CASE( element_checker_checker_optional_group )
{
	...
	LOG_INFO( "\n>>> element_checker_checker_optional_group repeated group <<<" );
	{
		...
		elem6->set( buff2, checker.getSize( elem6 ) );
		checker.check( elem6 );
		BOOST_CHECK_EQUAL( elem6->_status, eStatusValid );
		...
		elem7->set( buff4, checker.getSize( elem7 ) );
		checker.check( elem7 );
		...
		elem8->set( buff5, checker.getSize( elem8 ) );
		checker.check( elem8 );
		...
		elem9->set( buff6, checker.getSize( elem9 ) );
		checker.check( elem9 );
		...
		elem11->set( buff3, checker.getSize( elem11 ) );
